...
sleep 1
echo "starting ./yfs_client $YFSDIR1 $SERVER_HOST:$EXTENT_PORT > yfs_client1.log 2>&1 &"
./yfs_client $YFSDIR1 $SERVER_HOST:$EXTENT_PORT > yfs_client1.log 2>&1 &
sleep 1

rm -rf $YFSDIR2
mkdir $YFSDIR2 || exit 1
sleep 1
echo "starting ./yfs_client $YFSDIR2 $SERVER_HOST:$EXTENT_PORT > yfs_client2.log 2>&1 &"
./yfs_client $YFSDIR2 $SERVER_HOST:$EXTENT_PORT > yfs_client2.log 2>&1 &
